...
class SupportService:
    ...
    async def create_ticket(self, *, user_telegram_id: int, message: str) -> SupportTicket:
        ...
        return await self._support_repository.create(
            SupportTicket(id=None, user_telegram_id=user_telegram_id, message=message)
        )
    ...
    async def get_user_tickets_by_status(
        self, telegram_id: int, status: SupportStatus
    ) -> list[SupportTicket]:
    ...
    @transactional
    async def get_support_users_by_status(
