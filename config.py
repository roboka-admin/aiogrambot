...
# Event-table retention (anti-spam, membership checks, AI reports, closed
# support tickets). Must stay above 30 so 30-day admin statistics are unaffected.
EVENT_RETENTION_DAYS = int(os.getenv("EVENT_RETENTION_DAYS", "31"))
